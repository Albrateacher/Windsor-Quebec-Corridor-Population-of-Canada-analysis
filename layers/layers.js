...
var format_AdPointsStatsCanada_1 = new ol.format.GeoJSON();
var features_AdPointsStatsCanada_1 = format_AdPointsStatsCanada_1.readFeatures(json_AdPointsStatsCanada_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AdPointsStatsCanada_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AdPointsStatsCanada_1.addFeatures(features_AdPointsStatsCanada_1);
var lyr_AdPointsStatsCanada_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_AdPointsStatsCanada_1, 
                style: style_AdPointsStatsCanada_1,
                interactive: false,
                title: '<img src="styles/legend/AdPointsStatsCanada_1.png" /> Ad, Points, Stats Canada'
            });
...
var lyr_Cities_2 = new ol.layer.Vector({
                ...
                interactive: false,
                title: '<img src="styles/legend/Cities_2.png" /> Cities'
            });
...
var format_QuebecCityADPointsStatsCan2021_7 = new ol.format.GeoJSON();
var features_QuebecCityADPointsStatsCan2021_7 = format_QuebecCityADPointsStatsCan2021_7.readFeatures(json_QuebecCityADPointsStatsCan2021_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_QuebecCityADPointsStatsCan2021_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_QuebecCityADPointsStatsCan2021_7.addFeatures(features_QuebecCityADPointsStatsCan2021_7);
var lyr_QuebecCityADPointsStatsCan2021_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_QuebecCityADPointsStatsCan2021_7, 
                style: style_QuebecCityADPointsStatsCan2021_7,
                interactive: false,
                title: '<img src="styles/legend/QuebecCityADPointsStatsCan2021_7.png" /> Quebec City,AD Points, Stats Can 2021 '
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_AdPointsStatsCanada_1.setVisible(false);lyr_Cities_2.setVisible(true);lyr_LineWindsorQuebec_3.setVisible(true);lyr_BufferWindsorQuebec75Km_4.setVisible(true);lyr_DensityMapPopulationQuebecCity_5.setVisible(true);lyr_PolygonADCensus2021QuebecCity_6.setVisible(true);lyr_QuebecCityADPointsStatsCan2021_7.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_AdPointsStatsCanada_1,lyr_Cities_2,lyr_LineWindsorQuebec_3,lyr_BufferWindsorQuebec75Km_4,lyr_DensityMapPopulationQuebecCity_5,lyr_PolygonADCensus2021QuebecCity_6,lyr_QuebecCityADPointsStatsCan2021_7];
lyr_AdPointsStatsCanada_1.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'Name_2': 'Name_2', 'description_2': 'description_2', 'timestamp_2': 'timestamp_2', 'begin_2': 'begin_2', 'end_2': 'end_2', 'altitudeMode_2': 'altitudeMode_2', 'tessellate_2': 'tessellate_2', 'extrude_2': 'extrude_2', 'visibility_2': 'visibility_2', 'drawOrder_2': 'drawOrder_2', 'icon_2': 'icon_2', });
lyr_Cities_2.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_QuebecCityADPointsStatsCan2021_7.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_AdPointsStatsCanada_1.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'Name_2': 'TextEdit', 'description_2': 'TextEdit', 'timestamp_2': 'DateTime', 'begin_2': 'DateTime', 'end_2': 'DateTime', 'altitudeMode_2': 'TextEdit', 'tessellate_2': 'Range', 'extrude_2': 'Range', 'visibility_2': 'Range', 'drawOrder_2': 'Range', 'icon_2': 'TextEdit', });
lyr_Cities_2.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', });
...
lyr_QuebecCityADPointsStatsCan2021_7.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', });
lyr_AdPointsStatsCanada_1.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'Name_2': 'no label', 'description_2': 'no label', 'timestamp_2': 'no label', 'begin_2': 'no label', 'end_2': 'no label', 'altitudeMode_2': 'no label', 'tessellate_2': 'no label', 'extrude_2': 'no label', 'visibility_2': 'no label', 'drawOrder_2': 'no label', 'icon_2': 'no label', });
lyr_Cities_2.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
...
lyr_QuebecCityADPointsStatsCan2021_7.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'header label', 'icon': 'no label', });
lyr_QuebecCityADPointsStatsCan2021_7.on('precompose', function(evt) {
